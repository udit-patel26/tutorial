...
export class ProductListComponent {
  ...
  products = [
    {
      ...
      items_left: 3,
      imageURL: "https://th.bing.com/th/id/OIP.fThkbmtVk_eomkTj1wAexAHaEo?rs=1&pid=ImgDetMain",
  ...
  totalProuctOutOfStock=this.products.filter(p => p.is_in_inventory===false).length
